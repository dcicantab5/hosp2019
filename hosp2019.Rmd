...
* *Current Sharing workload (Fig 4):* `r text_formatted`. 
...
* *All in workload (Fig 5):* `r text_formatted`.
...
* Specialty composition: 55% (30) subs, 45% (25) gen med (Fig 6).
...
* Specialty composition: 68% (39) subs, 32% (18) gen med (Fig 6).
* Workload involvement: 
...
* Specialty composition: 79% (96) subs, 21% (27) gen med.
* Workload involvement: 
...
* Specialty composition: 82% (45) subs, 18% (10) gen med.
* Workload involvement:  
...
* Specialty composition: see Fig 6. 
