...
# Harmonising GenMed & Subs: 
## Case Study 1 - Drilldown HKL

* Subs-GenMed specialty composition: 82% (45) subs, 18% (10) gen med.
* Gen med workload involvement composition: 
...
* Standardised workload based on gen med admissions only, for HKL is 2 specialists per 1000 admissions (Median for all major hospitals 2.2).
  + *Shared workload (Fig 4): shortage of 8 specialists.*  
* Standardised workload based on all in admissions, for HKL is 3 specialists per 1000 admissions (Median for all major hospitals 2.7).
  + *All in workload (Fig 5): excess of 14 specialists.*
...
## Case Study 2 - Drilldown Serdang
...
* Standardised workload based on gen med admissions only, for Serdang is 2 specialists per 1000 admissions (Median for all major hospitals 1.41).
  + *Shared workload (Fig 4): excess of 5 specialists.*  
* Standardised workload based on all in admissions, for Serdang is 2.7 specialists per 1000 admissions (Median for all major hospitals 1.55).
  + *All in workload (Fig 5): excess of 24 specialists.*
...
## Case Study 3 - Drilldown Melaka

* 49% (17) subs, 51% (18) gen med.
* Dermatology is the only sub not involved in gen med workload (2).
* Standardised workload based on gen med admissions only, for Melaka is 1.4 specialists per 1000 admissions (Median for all state hospitals 2.2).
  + *Shared workload (Fig 4): shortage of 17 specialists.*  
* Standardised workload based on all in admissions, for Melaka is 1.7 specialists per 1000 admissions (Median for all state hospitals 2.7).
  + *All in workload (Fig 5): shortage of 21 specialists.*
