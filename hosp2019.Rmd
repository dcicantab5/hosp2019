...
url <- 'https://docs.google.com/spreadsheets/d/1SFtj8JD1JDLMUdUExFoovDt6uIAFh5pWSpxPzZ_xK1Q/edit?usp=sharing'  ### 7 March 2022
...
subplot(
  add_bars(p, color = ~factor(type), colors = col3,  showlegend = TRUE) 
     ...
     title = "General Medicine Admissions <br><sup></sup>",
     yaxis = list(title = "",
     categoryorder = "array",
...
# Number of Specialists Sharing General Medicine Workload
...
subplot(
  add_bars(p, color = ~factor(type), colors = col3,  showlegend = TRUE) 
     ...
     title = "Specialists Sharing General Medicine Workload<br><sup></sup>",
     yaxis = list(title = "",
     categoryorder = "array",
...
# Standardised Workload (Current Sharing)
